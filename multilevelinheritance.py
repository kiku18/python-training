...
class Parent(Gparent):
    def __init__(self,Fgfname,Fgmname,Fgfage,Fgmage,Fgplocation,Mgfname,Mgmname,Mgfage,Mgmage,Mgplocation,fname,mname,fage,mage,plocation):
...
class child(Parent):
    def __init__(self,Fgfname,Fgmname,Fgfage,Fgmage,Fgplocation,Mgfname,Mgmname,Mgfage,Mgmage,Mgplocation,fname,mname,fage,mage,plocation,cname,cage,clocation):
        Parent.__init__(self,Fgfname,Fgmname,Fgfage,Fgmage,Fgplocation,Mgfname,Mgmname,Mgfage,Mgmage,Mgplocation,fname,mname,fage,mage,plocation)
        self.cname = cname
        self.cage = cage
